    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Question_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionsAndAnswer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OptionsAndAnswer_Question_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionsAndAnswerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.OptionsAndAnswerId,
                        principalTable: "OptionsAndAnswer",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CandidateAnswers_Question_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Question",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OptionsAndAnswer_QuestionId",
                table: "OptionsAndAnswer",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Question_LanguageId",
                table: "Question",
                column: "LanguageId");
